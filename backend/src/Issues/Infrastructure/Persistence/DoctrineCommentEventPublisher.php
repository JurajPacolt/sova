...
final readonly class DoctrineCommentEventPublisher implements CommentEventPublisher
{
    private const string AGGREGATE_TYPE = 'ISSUE_COMMENT';
    ...
    public function publish(
        ...
        $this->connection->insert('outbox_events', [
            ...
            'event_version' => 1,
            // The comment version doubles as the aggregate sequence, so a replay
